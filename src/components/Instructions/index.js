    ...
    return (
      <div className="instructions">
        <div className="instructions__modal">
          ...
          <h2>Rules</h2>
          <p>This is a version of the Uwe Rosenberg two-player board game Patchwork.
            If you need to know how to play the game, you can find
            find <a href="https://www.youtube.com/watch?v=wo7QGN2u3a0&t=2m12s" rel="noopener noreferrer" target="_blank">a
            full explanation of the rules</a> at this link</p>
          <h2>Controls</h2>
          <ul>
